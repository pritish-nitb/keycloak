...
public class TestConsentRequiredExecutor implements ClientPolicyExecutorProvider {

    private static final Logger logger = Logger.getLogger(TestConsentRequiredExecutor.class);

    private final KeycloakSession session;
    private final ComponentModel componentModel;
    private final RealmModel realm;

    public TestConsentRequiredExecutor(KeycloakSession session, ComponentModel componentModel) {
