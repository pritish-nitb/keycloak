...
public class TestProtocolMappersExecutorFactory implements ClientPolicyExecutorProviderFactory {

	private KeycloakSessionFactory sessionFactory;

    private List<ProviderConfigProperty> configProperties = new LinkedList<>();

    public static final String PROVIDER_ID = "test-allowed-protocol-mappers";
    ...
    public ClientPolicyExecutorProvider create(KeycloakSession session, ComponentModel model) {
        return new TestProtocolMappersExecutor(session, model);
    }
