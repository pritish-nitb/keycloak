...
public class TestClientScopesExecutorFactory implements ClientPolicyExecutorProviderFactory {

    private List<ProviderConfigProperty> configProperties;

    // Keeping the name for backwards compatibility
    public static final String PROVIDER_ID = "test-allowed-client-templates";
    ...
    public ClientPolicyExecutorProvider create(KeycloakSession session, ComponentModel model) {
        return new TestClientScopesExecutor(session, model);
    }
