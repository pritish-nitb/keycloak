...
public class TestClientScopesExecutor implements ClientPolicyExecutorProvider {

    private static final Logger logger = Logger.getLogger(TestClientScopesExecutor.class);

    private final KeycloakSession session;
    private final ComponentModel componentModel;
    private final RealmModel realm;

    public TestClientScopesExecutor(KeycloakSession session, ComponentModel componentModel) {
    ...
    private List<String> getAllowedScopeNames(RealmModel realm, boolean defaultScopes) {
        ...
        List<String> allowedScopesConfig = componentModel.getConfig().getList(TestClientScopesExecutorFactory.ALLOWED_CLIENT_SCOPES);
        ...
        boolean allowDefaultScopes = componentModel.get(TestClientScopesExecutorFactory.ALLOW_DEFAULT_SCOPES, true);
