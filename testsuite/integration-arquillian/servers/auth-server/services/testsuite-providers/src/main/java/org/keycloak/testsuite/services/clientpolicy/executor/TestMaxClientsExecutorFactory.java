...
public class TestMaxClientsExecutorFactory implements ClientPolicyExecutorProviderFactory {
    ...
    public static final String PROVIDER_ID = "test-max-clients";

    @Override
    public ClientPolicyExecutorProvider create(KeycloakSession session, ComponentModel model) {
        return new TestMaxClientsExecutor(session, model);
    }
