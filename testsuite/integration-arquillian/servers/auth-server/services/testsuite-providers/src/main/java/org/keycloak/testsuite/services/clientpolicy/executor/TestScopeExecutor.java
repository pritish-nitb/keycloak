...
public class TestScopeExecutor implements ClientPolicyExecutorProvider {

    private static final Logger logger = Logger.getLogger(TestScopeExecutor.class);

    private final KeycloakSession session;
    private final ComponentModel componentModel;

    public TestScopeExecutor(KeycloakSession session, ComponentModel componentModel) {
