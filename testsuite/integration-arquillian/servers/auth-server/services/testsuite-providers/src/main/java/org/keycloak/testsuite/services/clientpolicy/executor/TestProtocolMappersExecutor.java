...
public class TestProtocolMappersExecutor implements ClientPolicyExecutorProvider {

    private static final Logger logger = Logger.getLogger(TestProtocolMappersExecutor.class);

    private final KeycloakSession session;
    private final ComponentModel componentModel;

    public TestProtocolMappersExecutor(KeycloakSession session, ComponentModel componentModel) {
    ...
    private List<String> getAllowedMapperProviders() {
        return componentModel.getConfig().getList(TestProtocolMappersExecutorFactory.ALLOWED_PROTOCOL_MAPPER_TYPES);
    }
}
