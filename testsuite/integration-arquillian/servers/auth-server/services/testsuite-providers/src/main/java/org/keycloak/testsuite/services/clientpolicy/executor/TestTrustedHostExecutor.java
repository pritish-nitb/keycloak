...
public class TestTrustedHostExecutor implements ClientPolicyExecutorProvider {

    private static final Logger logger = Logger.getLogger(TestTrustedHostExecutor.class);

    private final KeycloakSession session;
    private final ComponentModel componentModel;

    public TestTrustedHostExecutor(KeycloakSession session, ComponentModel componentModel) {
    ...
    protected List<String> getTrustedHosts() {
        List<String> trustedHostsConfig = componentModel.getConfig().getList(TestTrustedHostExecutorFactory.TRUSTED_HOSTS);
    ...
    boolean isHostMustMatch() {
        return parseBoolean(TestTrustedHostExecutorFactory.HOST_SENDING_REGISTRATION_REQUEST_MUST_MATCH);
    }

    boolean isClientUrisMustMatch() {
        return parseBoolean(TestTrustedHostExecutorFactory.CLIENT_URIS_MUST_MATCH);
    }
