...
public class TestMaxClientsExecutor implements ClientPolicyExecutorProvider {

    private static final Logger logger = Logger.getLogger(TestMaxClientsExecutor.class);

    private final KeycloakSession session;
    private final ComponentModel componentModel;

    public TestMaxClientsExecutor(KeycloakSession session, ComponentModel componentModel) {
    ...
    private void beforeRegister(ClientRepresentation proposedClient) throws ClientPolicyException {
        ...
        int maxCount = componentModel.get(TestMaxClientsExecutorFactory.MAX_CLIENTS, TestMaxClientsExecutorFactory.DEFAULT_MAX_CLIENTS);
