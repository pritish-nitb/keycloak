...
class BackchannelAuthenticationQueryStringParser extends BackchannelAuthenticationRequestParser {

    private final MultivaluedMap<String, String> requestParams;

    private String invalidRequestMessage = null;

    public BackchannelAuthenticationQueryStringParser(MultivaluedMap<String, String> requestParams) {
